...
template Status MediapipeGraphExecutor::inferEx<
    KFSRequest,
    KFSServerReaderWriter>(
            const   KFSRequest&,
                    KFSServerReaderWriter&);
